...
def Bayesian_model(train_data, training_targets, test_data, test_targets):
...
# Example usage
# I recommend that you delete the *.png, *.csv, *.npz files before running the autoencoder program
...
# Insert your classifier model here

# create_ a 4 layer classifier model
# note my classifier model does not work
